...
export default function About() {
  ...
  function getdark()
  {
      if(mystyle.backgroundColor=='rgb(31, 31, 146)')
      {
        setmystyle(
            {
                color:'black',backgroundColor:'white'   
        ...
        setmystyle(
            {
                color:'white',backgroundColor:'rgb(31, 31, 146)'   
              }
        )
      }
      if(text1=='Enable Dark Mode'){
...
<div className="button1"> <button  className='btn btn-primary' onClick={getdark}  > {text1}</button></div>
    </div>
  )
}
